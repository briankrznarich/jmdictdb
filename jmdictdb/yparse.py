...
# Ply-3.11 (http://dabeaz.com/ply/index.html) in example/yply/yparse.py.
# It has been modified to allow Python code in rule actions.  (The
# original version, like the original Unix YACC, expects C code in
# the actions.)
