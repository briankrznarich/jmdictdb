# This file is a modified version of an example file provided with
# Ply-3.11 (http://dabeaz.com/ply/index.html) in example/yply/ylex.py.
# It has been modified for use with a corresponding yparse.y that has
# bee modified to allow Python code (rather than C) in rule actions.
