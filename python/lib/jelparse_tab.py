...
_lr_productions = [
  ...
  ('atext -> TEXT','atext',1,'p_atext_1','jelparse.py',300),
  ('atext -> QTEXT','atext',1,'p_atext_2','jelparse.py',304),
  ('jrefs -> jref','jrefs',1,'p_jrefs_1','jelparse.py',308),
  ('jrefs -> jrefs SEMI jref','jrefs',3,'p_jrefs_2','jelparse.py',312),
  ('jref -> xrefnum','jref',1,'p_jref_1','jelparse.py',316),
  ('jref -> xrefnum slist','jref',2,'p_jref_2','jelparse.py',320),
  ('jref -> xrefnum DOT jitem','jref',3,'p_jref_3','jelparse.py',324),
  ('jref -> jitem','jref',1,'p_jref_4','jelparse.py',328),
  ('jref -> jitem TEXT','jref',2,'p_jref_5','jelparse.py',332),
  ('jitem -> dotlist','jitem',1,'p_jitem_1','jelparse.py',336),
  ('jitem -> dotlist slist','jitem',2,'p_jitem_2','jelparse.py',340),
  ('dotlist -> jtext','dotlist',1,'p_dotlist_1','jelparse.py',344),
  ('dotlist -> dotlist DOT jtext','dotlist',3,'p_dotlist_2','jelparse.py',348),
  ('jtext -> KTEXT','jtext',1,'p_jtext_1','jelparse.py',352),
  ('jtext -> RTEXT','jtext',1,'p_jtext_2','jelparse.py',356),
  ('jtext -> QTEXT','jtext',1,'p_jtext_3','jelparse.py',360),
  ('xrefnum -> NUMBER','xrefnum',1,'p_xrefnum_1','jelparse.py',364),
  ('xrefnum -> NUMBER HASH','xrefnum',2,'p_xrefnum_2','jelparse.py',368),
  ('xrefnum -> NUMBER TEXT','xrefnum',2,'p_xrefnum_3','jelparse.py',372),
  ('slist -> BRKTL snums BRKTR','slist',3,'p_slist_1','jelparse.py',376),
  ('snums -> NUMBER','snums',1,'p_snums_1','jelparse.py',380),
  ('snums -> snums COMMA NUMBER','snums',3,'p_snums_2','jelparse.py',387),
]
